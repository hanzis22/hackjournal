...
export default function ShareWrapper({ writeup: initialWriteup }: Props) {
  ...
  if (isDecrypting) {
    return (
      <div style={{ minHeight:'100vh', background:'var(--bg)', color:'var(--text)', padding:'40px 20px', display:'flex', justifyContent:'center', alignItems: 'center' }}>
        <EncryptionGate
          initialWriteup={initialWriteup}
          onDecrypted={handleDecrypted}
          onBack={() => router.push('/login')}
          backLabel="Ke Login"
          description="Laporan publik ini dilindungi dengan enkripsi. Masukkan passphrase enkripsi untuk membuka isi laporan."
        />
      </div>
    )
  }
  ...
  return (
    <div style={{ minHeight:'100vh', background:'var(--bg)', color:'var(--text)', padding:'40px 20px', display:'flex', justifyContent:'center' }}>
      <div className="detail-page-wrapper" style={{ width:'100%', maxWidth:'900px' }}>
